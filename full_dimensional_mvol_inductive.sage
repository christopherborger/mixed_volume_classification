...
def empty_subsimplices_up_to_symmetry(container):
    """
        ...
        Two empty simlices S and T are equivalent if there exists an affine unimodular transformation 
...
class SandwichFactoryForFixedPolytope:
    # TODO: integrate implementations of some of the following functions as methods 
    def append_sandwich_up_to_translation(self,A,B):
        pass
    def __init__(self,initial_polytopes,container,fixed_polytope,m):
        pass
    def iterative_pealing_off(self,A,B):
        pass
    def pealing_off(self,A,B):
        pass
    def choices_of_the_next_polytope(self):
        """
            is subpolytopes_using_sandwiches(container,fixed_polytope,m)
        """
        pass 
